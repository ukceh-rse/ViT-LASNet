...
Save_path = '/noc/users/noueft/Documents/corrected-data-elastic-eggs/code/training-versions/46-20-May-RGB'
# data_dir = '/noc/users/noueft/Documents/elastic-eggs-three-class-split'
# data_dir =  "/noc/users/noueft/Documents/amused-ants"
...
# Save_path = '/noc/users/noueft/Documents/Code/weighted-loss/New_version_RGB/AA'
...
def main(use_gray_model=True):
    ...
    model_name = 'resnet18_model_gray_weights_14May.pth' if use_gray_model else 'resnet18_model_rgb_weights_20May.pth'
...
if __name__ == "__main__":
    ...
    use_gray_model = False  # Set to True for grayscale, False for RGB
    main(use_gray_model)
